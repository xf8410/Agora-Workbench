...
Agora can execute commands on remote machines through the [Conch](https://github.com/xf8410/conch) protocol — an end-to-end encrypted secure shell designed for AI agents.
...
Deploy the Conch server on your target machine. See the [Conch repository](https://github.com/xf8410/conch) for setup instructions.
...
See the [Conch documentation](https://github.com/xf8410/conch) for MCP setup instructions.
