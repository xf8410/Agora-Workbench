...
Agora puede ejecutar comandos en máquinas remotas a través del protocolo [Conch](https://github.com/xf8410/conch) — un shell seguro cifrado de extremo a extremo diseñado para agentes de IA.
...
Despliega el servidor Conch en tu máquina de destino. Consulta el [repositorio de Conch](https://github.com/xf8410/conch) para instrucciones de configuración.
...
Consulta la [documentación de Conch](https://github.com/xf8410/conch) para instrucciones de configuración MCP.
