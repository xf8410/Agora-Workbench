...
Agora 可以通过 [Conch](https://github.com/xf8410/conch) 协议在远程机器上执行命令——一个专为 AI 代理设计的端到端加密安全 Shell。
...
在目标机器上部署 Conch 服务器。详见 [Conch 仓库](https://github.com/xf8410/conch) 的安装说明。
...
详见 [Conch 文档](https://github.com/xf8410/conch) 的 MCP 设置说明。
