...
@Serializable data class AttachmentMeta(val items: List<AttachmentItem> = emptyList())

/** Workbook contents stay outside Room and are loaded only when a viewer or model request needs them. */
...
@Serializable private data class AttachmentItemSurrogate(val originalUri: String? = null, val type: String, @SerialName("file_name") val fileName: String? = null, @SerialName("mime_type") val mimeType: String? = null, @SerialName("image_index") val imageIndex: Int? = null, @SerialName("page_count") val pageCount: Int? = null, val warning: String? = null, @SerialName("text_content") val textContent: String? = null, @SerialName("content_path") val contentPath: String? = null, val transcription: String? = null)
...
@Serializable data class SelectedAttachment(val uri: String, val type: String, val frameCount: Int? = null, val sliceIntervalMs: Long? = null, val fileName: String? = null, val mimeType: String? = null, val fileSize: Long? = null, val processedFrames: List<String>? = null, val selectedPages: Set<Int>? = null, val preRenderedPaths: List<String>? = null, val localPath: String? = null)
